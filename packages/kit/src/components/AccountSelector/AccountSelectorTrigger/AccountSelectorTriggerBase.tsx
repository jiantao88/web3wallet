...
import { AccountSelectorWalletListSideBar } from '../../../views/AccountManagerStacks/pages/AccountSelectorStack/WalletList';
...
export function AccountSelectorTriggerBase({
  ...
  const DialogContent = ({ num }: { num: number }) => {
  ...
  //   Dialog.show({
  //     title:'',
  //     renderContent:<DialogContent num={num}/>,
  //     showFooter:false
  //   })
  // },[account,dbAccount,indexedAccount,intl,num])
